            ...
            <form class="tablelist-form" wire:submit='updateUser'>
                ...
                <div class="flex justify-end gap-2">
                    <button type="submit"
                        ...
                        id="update-btn">Update User</button>
                </div>
            </form>
        </div>
    </div>
