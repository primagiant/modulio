<div wire:ignore.self id="startResumeModal" modal-center
    ...
    <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
            <div class="float-right">
                <button data-modal-close="startResumeModal"
            ...
            <div class="mt-5 text-center">
                <h5 class="mb-1">Apakah anda yakin mulai mengerjakan resume?</h5>
                <p class="text-slate-500 dark:text-zink-200">Waktu pengerjaan resume akan dimulai sesaat anda menekan
                    tombol mulai, dibawah ini</p>
                <div class="flex gap-2 justify-center mt-6">
                    <button type="button" data-modal-close="startResumeModal"
                    ...
                    <button type="button" data-modal-close="startResumeModal" wire:click='startResume'
