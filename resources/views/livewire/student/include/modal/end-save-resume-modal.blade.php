<div wire:ignore.self id="endModulModal" modal-center
    ...
    <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
            <div class="float-right">
                <button data-modal-close="endModulModal"
            ...
            <div class="mt-5 text-center">
                <h5 class="mb-1">Apakah anda yakin mengakhiri modul?</h5>
                <p class="text-slate-500 dark:text-zink-200">Waktu pengerjaan modul akan disimpan setelah anda menekan
                    tombol "Akhiri Modul" dibawah ini</p>
                <div class="flex gap-2 justify-center mt-6">
                    <button type="button" data-modal-close="endModulModal"
                    ...
                    <button type="button" data-modal-close="endModulModal" wire:click='endModule'
                        class="text-white bg-yellow-500 border-yellow-500 btn hover:text-white hover:bg-yellow-600 hover:border-yellow-600 focus:text-white focus:bg-yellow-600 focus:border-yellow-600 focus:ring focus:ring-yellow-100 active:text-white active:bg-yellow-600 active:border-yellow-600 active:ring active:ring-yellow-100 dark:ring-custom-400/20">Akhiri
                        Modul</button>
                </div>
            </div>
        </div>
