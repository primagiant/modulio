<div wire:ignore.self id="deleteQuestConfirmModal" modal-center
    ...
    <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
            <div class="float-right">
                <button data-modal-close="deleteQuestConfirmModal" id="close-removeNotesModal"
            ...
            <div class="mt-5 text-center">
                ...
                <div class="flex gap-2 justify-center mt-6">
                    <button type="button" data-modal-close="deleteQuestConfirmModal"
                        class="bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dark:bg-zink-600 dark:hover:bg-slate-500/10 dark:focus:bg-slate-500/10 dark:active:bg-slate-500/10">Cancel</button>
                    <button type="button" wire:click='destroyQuestion' data-modal-close="deleteQuestConfirmModal"
