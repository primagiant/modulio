...
@once
    <x-dialog-modal wire:model.live="confirmingPassword">
        ...
        <x-slot name="footer">
            <x-secondary-button variant="red" wire:click="stopConfirmingPassword" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-secondary-button>

            <x-button variant="green" class="ms-3" dusk="confirm-password-button" wire:click="confirmPassword"
